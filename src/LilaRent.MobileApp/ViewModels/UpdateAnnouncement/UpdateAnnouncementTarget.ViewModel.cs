...
internal partial class UpdateAnnouncementTargetViewModel : ObservableValidator
{
    ...
    public AnnouncementUpdatingDtoBuilder? Builder 
    {
        ...
        set
        {
            ...
            RentObjectName = _builder.RentObjectName;
    ...
    public UpdateAnnouncementTargetViewModel(INavigationService navigationService)
    {
    ...
    private void Next()
    {
        ...
        _navigationService.CurrentTabs.Navigation.Push<UpdateAnnouncementFilesViewModel>(new { Builder });
    }
