...
public partial class NewAnnouncementDiscountParametersViewModel : ObservableValidator
{
    ...
    public NewAnnouncementDiscountParametersViewModel(INavigationService navigationService)
    {
