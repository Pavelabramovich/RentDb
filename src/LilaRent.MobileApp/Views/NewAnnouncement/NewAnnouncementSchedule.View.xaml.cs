...
public partial class NewAnnouncementScheduleView : ContentPage
{
    ...
    public NewAnnouncementScheduleView()
    {
        InitializeComponent();
    }

    public new NewAnnouncementScheduleViewModel BindingContext => (NewAnnouncementScheduleViewModel)base.BindingContext;
